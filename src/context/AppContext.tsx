...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const govTranslations: Record<string, Record<string, string>> = {
      ...
      nav_sla_alerts: "SLA Alerts",
      nav_citizen_reports: "Citizen Reports",
      nav_hotspots: "Recurring Hotspots",
      nav_settings: "Settings",
      nav_views: "VIEWS",
      nav_language: "LANGUAGE / தமிழ் / हिंदी",
      nav_sign_out: "Sign Out",
      sign_out_confirm: "Are you sure you want to sign out of the Government Portal?",
      kpi_active_issues: "Active Issues",
      kpi_critical: "Critical & High",
      kpi_reopened: "Reopened",
      kpi_sla_breach: "SLA Breaches",
      priority_queue: "Priority Action Queue",
      dept_workload: "Department Workload",
      view_all: "View All",
      th_priority: "Priority",
      th_details: "Issue Details",
      ...
      nav_field_ops: "கள செயல்பாடுகள்",
      nav_sla_alerts: "SLA எச்சரிக்கைகள்",
      nav_citizen_reports: "குடிமக்கள் புகார்கள்",
      nav_hotspots: "தொடர்ச்சியான இடங்கள்",
      nav_settings: "அமைப்புகள்",
      nav_views: "காட்சிகள்",
      nav_language: "மொழி / தமிழ் / हिंदी",
      nav_sign_out: "வெளியேறு",
      sign_out_confirm: "அரசு போர்ட்டலில் இருந்து வெளியேற விரும்புகிறீர்களா?",
      kpi_active_issues: "செயலில் உள்ள பிரச்சனைகள்",
      kpi_critical: "அவசரமானவை",
      kpi_reopened: "மீண்டும் திறக்கப்பட்டவை",
      kpi_sla_breach: "SLA மீறல்கள்",
      priority_queue: "முன்னுரிமை செயல் வரிசை",
      dept_workload: "துறை வேலைப்பளு",
      view_all: "அனைத்தையும் காண்க",
      th_priority: "முன்னுரிமை",
      th_details: "பிரச்சனை விவரங்கள்",
      th_location: "இடம்",
      th_assignee: "பொறுப்பாளர்",
      btn_manage: "நிர்வகி",
    },
            hi: {
      nav_overview: "अवलोकन",
      ...
      nav_field_ops: "क्षेत्र संचालन",
      nav_sla_alerts: "SLA अलर्ट",
      nav_citizen_reports: "नागरिक रिपोर्ट",
      nav_hotspots: "आवर्ती हॉटस्पॉट",
      nav_settings: "सेटिंग्स",
      nav_views: "दृश्य",
      nav_language: "भाषा / தமிழ் / हिंदी",
      nav_sign_out: "साइन आउट",
      sign_out_confirm: "क्या आप वाकई सरकारी पोर्टल से साइन आउट करना चाहते हैं?",
      kpi_active_issues: "सक्रिय समस्याएँ",
      kpi_critical: "गंभीर",
      kpi_reopened: "फिर से खोला गया",
      kpi_sla_breach: "SLA उल्लंघन",
      priority_queue: "प्राथमिकता कार्रवाई कतार",
      dept_workload: "विभाग कार्यभार",
      view_all: "सभी देखें",
      th_priority: "प्राथमिकता",
      th_details: "समस्या विवरण",
      th_location: "स्थान",
      th_assignee: "सौंपा गया",
